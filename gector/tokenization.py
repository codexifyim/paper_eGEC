...
#         t0 = time()
#         # Manually compute BPE-level offsets since `return_offsets_mapping` is unavailable
#         bpe_offsets = get_bpe_offsets_from_tokens(tokenizer_output['tokens'][i])
#         bpe_groups, saved_ids = get_bpe_groups(token_offsets, bpe_offsets,
#                                                input_ids,
#                                                max_bpe_pieces=max_bpe_pieces)
#         t1 = time()
...
# def get_bpe_offsets_from_tokens(tokens):
#     """Manually compute BPE-level offsets from tokenized text."""
#     bpe_offsets = []
#     current_offset = 0
#     for token in tokens:
#         start_offset = current_offset
#         end_offset = current_offset + len(token)
#         bpe_offsets.append((start_offset, end_offset))
...
#     # Manually batch encode using encode_plus
#     tokenizer_output = {
#         'input_ids': [],
#         'tokens': []
#     }
...
#             return_tensors=None
#         )
#         tokenizer_output['input_ids'].append(encoded['input_ids'])
#         tokenizer_output['tokens'].append(tokenizer.tokenize(sentence))
